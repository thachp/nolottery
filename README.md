...
California currently has EV, fetch, audit, and low-share support for its cataloged draw games. New York, Florida, and District of Columbia have representative catalog entries, with New York Numbers/Win 4 and Florida Pick 2/Pick 3/Pick 4/Pick 5 also supporting EV, fetch, and low-share. Arizona, Arkansas, Colorado, Connecticut, Delaware, Georgia, and Texas Powerball and Mega Millions support EV, fetch, audit, low-share, and one-page historical backfill from official past winning-number pages.
