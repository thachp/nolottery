...
California currently has EV, fetch, audit, and low-share support for its cataloged draw games. New York and Florida have representative catalog entries, with New York Numbers/Win 4/Quick Draw/Pick 10 and Florida Pick 2/Pick 3/Pick 4/Pick 5 also supporting EV, fetch, and low-share. District of Columbia has fetch, audit, and historical backfill support for its active draw-game catalog from the official DC past draw numbers page; DC-3, DC-4, DC-5, Powerball, Mega Millions, Lotto America, and Millionaire for Life also have EV and low-share support. Nebraska has full EV, fetch, audit, low-share, and historical backfill support for its official draw-result catalog, including Lucky for Life. Arkansas has EV, fetch, audit, low-share, and one-page historical backfill support for its active draw-game catalog, including Cash 3, Cash 4, LOTTO, Natural State Jackpot, Lucky for Life, and Millionaire for Life. Georgia Cash 3, Cash 4, Cash Pop, Georgia Five, and Millionaire for Life now have EV, fetch, audit, and low-share support from the official draw-games API. Massachusetts Lucky for Life and Millionaire for Life now have EV, fetch, audit, and low-share support from the official draw-results API. Michigan active draw games now have EV, fetch, audit, and low-share support from the official GraphQL draw-history and payout APIs; Lucky for Life is cataloged as retired after February 21, 2026. Minnesota Lotto America and Pick 3 have EV, fetch, audit, and low-share support from the official winning-numbers page. Mississippi Cash 3 and Cash 4 have EV, fetch, audit, and low-share support from the official home-page results. Arizona, Arkansas, Colorado, Connecticut, Delaware, Georgia, Idaho, Illinois, Indiana, Iowa, Kansas, Kentucky, Louisiana, Maine, Maryland, Massachusetts, Michigan, Minnesota, Mississippi, Missouri, Montana, New Hampshire, New Jersey, New Mexico, North Carolina, North Dakota, Ohio, Oklahoma, Oregon, Pennsylvania, Rhode Island, South Carolina, South Dakota, Tennessee, Texas, Vermont, Virginia, West Virginia, Wisconsin, and Wyoming Powerball and Mega Millions support EV, fetch, audit, low-share, and one-page historical backfill from official past winning-number pages.
...
Some adapters use official JSON/GraphQL sources instead of HTML. Michigan
backfill fixtures use the same slug-based directory pattern with a `.json`
suffix, such as `michigan-cash-pop-mi-backfill.json` or
`michigan-fantasy-5-mi-backfill.json`.
